...
document.querySelector(".count-child .count-minus").addEventListener("click", function() {
...
document.querySelector(".count-child .count-plus").addEventListener("click", function() {
	var val = document.querySelector(".child-number").getAttribute('value');
	val = +val + 1;
	document.querySelector(".child-number").setAttribute('value', val);
...
document.querySelector(".count-adult .count-minus").addEventListener("click", function() {
...
document.querySelector(".count-adult .count-plus").addEventListener("click", function() {
	var val = document.querySelector(".adult-number").getAttribute('value');
	val = +val + 1;
	document.querySelector(".adult-number").setAttribute('value', val);
